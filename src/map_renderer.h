...
class SphereProjector {
 public:
  ...
  svg::Point operator()(transpot_guide::detail::Coordinates coords) const {
...
std::vector<svg::Polyline> DrawLineofRoad(const transpot_guide::Bus* bus,
                                          RenderSettings& settings,
